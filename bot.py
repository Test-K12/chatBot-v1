...
def start(update, context):
    update.message.reply_text(
        "Это самый лучший женобот на этой планеты. Скинь свою реальную фоточку и я скажу, что думаю о тебе")
...
def main():
    updater = Updater("6110468081:AAFnGmDP0LNlLfjThGv3l1LJ-8bYCYKeIxo", use_context=True)
